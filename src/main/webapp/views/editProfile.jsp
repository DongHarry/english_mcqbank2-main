...
<div class="br-header">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-header wd-250">
            <div class="tx-center">
                <a href=""><img src="<c:url value="/resource/img/favicon.png"/>" class="wd-80 rounded-circle"
                                alt=""></a>
                ...
                <div class="tab-pane" id="changePass">
                    <form:form action="${pageContext.request.contextPath}/user/profile/edit" method="post">
                        ...
                        <div class="row pd-t-20">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="fullName" name="fullName" value="${currentUser.fullName}"
                                           required
                            ...
                            <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="phone" name="phone" value="${currentUser.phone}" required
                                           class="form-control" placeholder="Phone" pattern="\d{10}"
                            ...
                            <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="email" name="email" value="${currentUser.email}" required
                                           ...
                                           title="Vui lòng nhập đúng định dạng địa chỉ email">
                                </div><!-- input-group -->
                            </div><!-- col-4 -->
                        </div>
                        ...
                        <div class="form-layout-footer mg-t-30">
                            ...
                            <a href="${pageContext.request.contextPath}/user/profile" class="btn btn-secondary">Quay
                                lại</a>
