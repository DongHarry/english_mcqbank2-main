...
<div class="br-sideleft sideleft-scrollbar">
    ...
    <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
            <a href="${pageContext.request.contextPath}/admin/topics" class="br-menu-link active show-sub">
...
<div class="br-mainpanel">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <form:form action="/admin/topics/${c_topic.id}/edit" method="post">
                    ...
                    <div class="col-lg-8">
                        <div class="input-group">
                            ...
                            <input type="text" name="description" id="description"
                                   class="form-control" value="${c_topic.description}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-layout-footer mg-t-30">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/topics" class="btn btn-secondary">Quay lại</a>
                </div>
