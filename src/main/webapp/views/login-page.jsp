        ...
        <div class="login-wrapper wd-250 wd-xl-350 mg-y-30">
            ...
            <form:form action="${pageContext.request.contextPath}/login-processing" method="post" class="login-form"
                ...
                <div class="form-group">
                    <input type="text" name="username" id="username" pattern="[a-zA-Z0-9._]+" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <a href="${pageContext.request.contextPath}/forgot-password" class="tx-info tx-12 d-block mg-t-10">Forgot
                        password?</a>
                </div>
                <!-- form-group -->
            ...
            <div class="mg-t-60 tx-center">Not yet a member? <a href="${pageContext.request.contextPath}/register"
