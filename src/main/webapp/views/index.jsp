                        ...
                        <div class="hero-content-wrap">
                            <div class="hero-content">
                                ...
                                <div class="slider-action-btn">
                                    <a href="${pageContext.request.contextPath}/register" class="btn softo-solid-btn">Đăng
                                        kí ngay để trải nghiệm</a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 hidden-sm hidden-xs">
                        <div class="feature-image">
                            <img src="<c:url value="${pageContext.request.contextPath}/resource/img/feature-image.png"/>" class="pos-hcenter img-responsive" alt="">
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <!--feature single start-->
