                            ...
                            <td>
                                <ul>
                                    <li style="list-style: none; margin-left: -40px;">
                                        View: <a href="${pageContext.request.contextPath}/admin/users/${user.id}"
                                                 class="btn btn-outline-primary btn-icon mg-r-5 mg-b-10" title="View"><i
                                            class="fas fa-eye"></i></a>
                                    </li>
                                    <li style="list-style: none; margin-left: -40px;">
                                        <c:if test="${user.groupId == 1}">
                                            Delete: <a
                                                href="#" data-row-id="${user.username}"
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content bd-0 tx-14">
            ...
            <div class="modal-body pd-20">
                <p id="modal-message" class="mg-b-5">Are you sure to delete this user?</p>
            </div>
...
<script>
    $(function () {
        ...
        $('.modal-effect1').on('click', function (e) {
            ...
            var newHref = "${pageContext.request.contextPath}/admin/delete?username=" + rowId;
            // Sửa thuộc tính href của thẻ a
            $(".save-changes-btn").attr("href", newHref);
            $("#modal-message").text("Are you sure to delete user: " + rowId + "?");
        });
